...
public class BAUtils {
	...
	private static int getUserSelection() {
		return readInt("Lütfen seçiminizi yapýnýz");
	}

	private static void showMenuItems(TreeMap<Integer, String> menuItems) { // en doðru veri yapýsý
...
//		scan.nextLine();
	...
	public static int[] readInt(String start, String query, int numElements) {
		...
		for (int i = 0; i < numElements; i++) {
			System.out.print((i + 1) + ". deðeri giriniz: ");
...
//		scan.nextLine();
	...
	/**
	 * long þeklinde belirtilmiþ bir zaman bilgisini dd.MMM.yyyy þeklinde ger döner
	 * 
	...
	/**
	 * Enlem ve boylam verileri verilmiþ bir yer için hava kirliliði bilgilerini
	 * geri döner
	 * 
	...
	/**
	 * Enlem ve boylam verileri verilmiþ bir yer için günlük hava tahmini bilgisini
	 * geri döner
	 * 
	 * @param lat Enlem bilgisi
	 * @param lon Boylam bilgisi
	...
	/**
	 * Verilen bilgiler dahilinde 3er saatlik aralýklala yapýlmýþ 5 adet hava
	 * tahminini geri döner
	 * 
	 * @param ilce Bir þehrin ilçesinin adý
	 * @param il   þehir adý
	 * @param ulke IOS ülke kýsa kodlarý, Türkiye için TR
	 * @return
	 */
	...
	/**
	 * Verilen bilgiler dahilinde bir ilçenin enlem ve boylam bilgilerine ulaþmak
	 * için kullanýlýr
	 * 
	 * @param ilce Bir þehrin ilçesinin adý
	 * @param il   þehir adý
