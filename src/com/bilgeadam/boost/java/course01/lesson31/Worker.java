...
public class Worker extends Employee{
	...
	public Worker(Name name, Gender gender, CivilStatus marriageStatus, LocalDate birthDate, LocalDate startDate, double startSalary) {
	...
	public String toString() {
		...
		return "Hizmetli. [" + this.getRegistrationNumber() + " "  + this.getName() + " "  + this.getBirthDate() + " "  + this.getStartDate() + " "  + this.getStartSalary() + " "  + curSal    + "]";
	}
